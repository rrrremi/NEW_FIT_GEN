...
export async function linkExerciseToWorkout(
  ...
  console.log('linkExerciseToWorkout - Received params:', {
    workoutId,
    exerciseId,
  ...
  console.log('linkExerciseToWorkout - Insert object:', insertObject);
  ...
  if (error) {
    console.error('Database error when inserting workout_exercise:', error);
    console.error('Error details:', JSON.stringify(error));
    throw new Error(`Failed to link exercise to workout: ${error.message}`);
  } else {
    console.log('Successfully linked exercise to workout:', data);
    console.log('Saved rationale:', data?.rationale);
  }
